const Services = () => {
  const services = [
    {
      icon: "/assets/img/icons/construction.webp",
      title: "Construction",
      description:
    ...
    {
      icon: "/assets/img/icons/draft.webp",
    ...
    {
      icon: "/assets/img/icons/welding.webp",
    ...
    {
      icon: "/assets/img/icons/eco-house.webp",
    ...
    {
      icon: "/assets/img/icons/fridge.webp",
    ...
    {
      icon: "/assets/img/icons/repair-service.webp",
    ...
    {
      icon: "/assets/img/icons/pulse.webp",
    ...
    {
      icon: "/assets/img/icons/maintenance.webp",
      title: "Finishing",
      description:
    ...
    {
      icon: "/assets/img/icons/wrecking-ball.webp",
      title: "Demolish",
      description:
